...
$$
\mathcal{L}_{cycle} = \| \epsilon_{x\rightarrow y}^{detach} + \epsilon_{y\rightarrow x}(y_t^c, \bar y_0) - (\epsilon_x + \epsilon_y) \|_2^2
$$
...
$$
\mathcal{L}_{consis} = \| \epsilon_{x\rightarrow y}^{detach} + \epsilon_{x\rightarrow x}(y_t, x_0) - (\epsilon_x + \epsilon_y) \|_2^2
$$
...
$$
\mathcal{L}_{invar} = \| \epsilon_{x\rightarrow y}(x_t, x_0) - \epsilon_{y\rightarrow y}(x_t, \bar y_0)^{detach} \|_2^2
$$
