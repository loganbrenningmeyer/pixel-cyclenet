...
def main():
    ...
    num_seg_classes = source_config.model.num_seg_classes
    rgb_parent_dirs = set(source_config.data.rgb_parent_dirs) if source_config.data.get("rgb_parent_dirs") is not None else None
    label_parent_dir = source_config.data.label_parent_dir if source_config.data.get("label_parent_dir") is not None else None
    ...
    # -------------------------
    cond_mode = source_config.model.cond_mode
    use_spade = source_config.model.use_spade
    s_dim = OmegaConf.select(source_config, "model.s_dim", default=None)

    skip_block_mask = OmegaConf.select(source_config, "model.skip_block_mask", default=None)
    use_mid_skip = OmegaConf.select(source_config, "model.use_mid_skip", default=True)
