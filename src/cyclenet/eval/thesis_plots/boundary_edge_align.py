...
def plot_boundary_edge_alignment_samples(
    ...
    for triplet_idx in order:
        ...
        fig.suptitle(
            "Boundary-Edge Alignment Diagnostic\n"
            f"{name} | BER={ber:.3f}",
            y=1.02,
            fontsize=13.0,
        )
